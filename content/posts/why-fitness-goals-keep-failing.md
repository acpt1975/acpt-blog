...
But here's the uncomfortable truth: [research shows that 92% of people abandon their New Year's resolutions](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6111692/), with fitness goals being among the most commonly broken promises we make to ourselves.
...
Instead of committing to hour-long gym sessions, start with 10-15 minutes of movement. Instead of completely eliminating all your favourite foods, focus on adding one nutritious meal to your day. [Small, consistent actions compound over time](https://www.healthline.com/health/fitness/how-to-start-working-out) and create lasting change.
...
This black-and-white thinking is incredibly destructive. [Research on habit formation](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3505409/) shows that consistency, not intensity, is what creates lasting change.
...
1. **Choose one small habit** to focus on for the next 30 days
2. **Connect it to your deeper why**—write this down where you'll see it daily
3. **Design your environment** to support this habit
4. **Track your consistency**, not just your results
5. **Plan for obstacles**—what will you do when motivation is low?
